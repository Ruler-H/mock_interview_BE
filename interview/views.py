...
def question(request):
    ...
    data += f'\nuser: {career} {field} 기술 면접 예시 질문을 질문, 모범 답변, 질문 의도, 질문 난이도로 정리해서 한글로 답해줘. 질문 난이도는 상, 중, 하로 답변해줘. 오직 json 형태로만 응답주고, key 값으로는 question, perfectAnswer, intent, difficulty로 응답해줘.'
...
def field_question(request):
    ...
    data += f'\nuser: {field} 기술 면접 예시 질문을 질문, 모범 답변, 질문 의도, 질문 난이도로 정리해서 한글로 답해줘. 질문 난이도는 상, 중, 하로 답변해주고, 오직 json 형태로만 응답주고, key 값으로는 question, perfectAnswer, intent, difficulty로 응답해줘.'
